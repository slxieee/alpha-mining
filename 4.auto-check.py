...
parser.add_argument('--credentials_file', type=str, default="credentials.txt", help='账号文件')
parser.add_argument('--start_date', type=str, default="01-01", help='开始日期 (MM-DD格式)')
parser.add_argument('--end_date', type=str, default="12-31", help='结束日期 (MM-DD格式)')
parser.add_argument('--alpha_num', type=int, default=100000, help='要检查的Alpha数量')
